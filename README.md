...
- TypeCommandController (controller)
    ...
    - Використовує регулярний вираз загального формату для виокремлення дії, ідентифікатора та параметра, а також робить базові валідації і формує повідомлення про помилки вводу.
...
- ProjectCommandController (controller)
    ...
    - Використовує той самий шаблон регулярного виразу з опційним ID та дією C/U/D, але додатково розбиває параметри на пару url та type_name для створення або оновлення проєкту.
...
- CliView (view/controller для CLI)
